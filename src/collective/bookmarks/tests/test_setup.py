...
from collective.bookmarks.testing import COLLECTIVE_BOOKMARKS_INTEGRATION_TESTING  # noqa: E501
...
class TestSetup(unittest.TestCase):
    ...
    def test_browserlayer(self):
        ...
        from collective.bookmarks.interfaces import (
            ICollectiveBookmarksLayer)
